...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17-alpine docker.io/redis:7-alpine ghcr.io/patchmon/patchmon-backend:1.3.6 ghcr.io/patchmon/patchmon-frontend:1.3.6" \
    "${container}"
# Commit the image
